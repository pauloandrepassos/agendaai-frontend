...
import { getDayString, isBeforeCutoffTime } from "@/utils/dateUtils";
...
export default function ProductModal({
    ...
    const isToday = selectedDay === getDayString();
    const isAfterCutoff = isToday && !isBeforeCutoffTime();
          ...
          <ContentCard className="p-6 w-11/12 max-w-2xl flex flex-col gap-6">
            <div className="text-center">
              <p className="text-red-500 font-bold">
                Pedidos para o dia atual só podem ser feitos até as 14:00 horas.
              </p>
              <p>Por favor, selecione um dia futuro.</p>
            </div>
            ...
            <div className="flex flex-col gap-4 justify-center">
              ...
              {quantity + quantityInBasket >= 5 && (
                <div className="text-xs text-primary font-bold">
                  ...
                  <p>No momento você está limitado a pedir uma quantidade máxima de 5 itens no total.</p>
                </div>
              )}
            </div>
